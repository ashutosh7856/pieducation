 ...
 * the mobile action bar for z-index.
 */
  ...
  return (
    <>
      ...
      <dialog
        ...
        className="m-auto w-[min(28rem,calc(100vw-2rem))] rounded-2xl border border-line bg-white p-0 text-ink backdrop:bg-navy/60 backdrop:backdrop-blur-sm"
      >
